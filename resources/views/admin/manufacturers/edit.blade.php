            ...
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.manufacturers.update', $manufacturerWithDevices) }}" method="post" enctype="multipart/form-data">
                    ...
                    <p>Select Devices</p>
                        ...
                        <x-file-input type="file" name="manufacturer_img" placeholder="Manufacturer" class="w-full mt-6" field="manufacturer_img" :value="@old('manufacturer_img', $manufacturer->manufacturer_img)"></x-file-input>
