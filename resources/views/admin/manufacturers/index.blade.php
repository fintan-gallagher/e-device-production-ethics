    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-around">
                ...
                <a href="{{ route('admin.manufacturers.show', $manufacturer) }}" class="mt-4 mb-4 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 md:object-cover md:w-1/2 md:h-48">
