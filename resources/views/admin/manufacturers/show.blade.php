...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <h1 class="font-bold">Ethics Score</h2>
                                ...
                                <h1 class="font-bold">Biography</h2>
                                    ...
                                    <p>
                                        ...
                                        <a href="{{ route('admin.sustainables.show', $manufacturer->sustainable->id) }}" class="text-blue-500 hover:underline">
                                            {{ $manufacturer->name }}
                                        </a>
                                        @else
                                        @endif
            ...
            @if(!$manufacturer->sustainable)
            <x-primary-button>
                <a href="{{ route('admin.sustainables.create', ['manufacturer' => $manufacturer->id]) }}" class="btn btn-primary">Create Sustainable</a>
            </x-primary-button>
            @endif

            <x-primary-button class="my-3"><a href="{{ route('admin.manufacturers.edit', $manufacturer) }}">Edit</a></x-primary-button>
