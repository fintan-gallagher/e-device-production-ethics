<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ optional($device->manufacturer)->name }} {{ $device->model }}
        </h2>
    </x-slot>
            ...
            <div class="my-6 p-6 bg-gray-200 border-b border-gray-200 shadow-sm sm:rounded-lg">
                <div class="card lg:card-side bg-gray-300 shadow-xl flex">
                    ...
                    <div class="card-body w-1/2 m-4">
                        <h1 class="font-bold">Model</h2>
                            ...
                            <a href="{{ route('admin.devices.parts', $device) }}" class="text-blue-500 hover:underline">View Parts</a>
                            @endif
                                    ...
                                    <h1 class="font-bold">Price</h2>
                                        ...
                                        <h1 class="font-bold">Manufacturer</h2>
                                            <p>
                                                ...
                                                <a href="{{ route('admin.manufacturers.show', $device->manufacturer->id) }}" class="text-blue-500 hover:underline">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/3 px-2 pb-12">
                            <div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative smooth">
                                <a href="{{ route('admin.devices.show', $recommendedDevice) }}" class="no-underline hover:no-underline">
                ...
                <div class="container w-full max-w-6xl mx-auto px-2 py-8">
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/3 px-2 pb-12">
                            <div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative smooth">
                                <a href="{{ route('admin.devices.show', $recycledDevice) }}" class="no-underline hover:no-underline">
                ...
                <x-primary-button class="mb-2"><a href="{{ route('admin.devices.edit', $device) }}">Edit</a></x-primary-button>
