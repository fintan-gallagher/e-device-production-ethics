    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-1/3 px-2 pb-12">
                            <div class="h-full bg-white rounded overflow-hidden shadow-md hover:shadow-lg relative smooth">
                                <a href="{{ route('user.manufacturers.show', $manufacturer) }}" class="no-underline hover:no-underline">
            ...
            <x-primary-button class="mb-2">
                <a href="{{ route('user.manufacturers.show', $sustainable->manufacturer_id) }}">Back to Manufacturer</a>
            </x-primary-button>
